...
const { MessageFactory,  TeamsActivityHandler,
...
const WATERFALL_DIALOG = 'WATERFALL_DIALOG2';
const USERPROFILE_DIALOG = 'userProfileDialog';

class UserProfileDialog extends ComponentDialog {
    constructor(userState) {
        super(USERPROFILE_DIALOG);
    ...
    async getSingleMember(step) {
        try {
            ...
            if (e.code === 'MemberNotFoundInConversation') {
                return step.context.sendActivity(MessageFactory.text('Member not found.'));
            } else {
                throw e;
            }
        }
    ...
    async transportStep(step) {
        ...
        await this.getSingleMember(step);
...
module.exports.USERPROFILE_DIALOG = USERPROFILE_DIALOG;
